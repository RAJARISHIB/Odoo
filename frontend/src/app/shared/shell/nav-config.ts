...
export const NAV: readonly NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'My Payroll', path: '/payroll', icon: 'briefcase' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Role salary templates', path: '/settings/payroll-templates', icon: 'settings', requires: ['can_manage_organization'] },
      { label: 'Employee payroll', path: '/settings/payroll-assignments', icon: 'briefcase', requires: ['can_manage_organization'] },
      { label: 'Payroll documents', path: '/settings/payroll-documents', icon: 'file', requires: ['can_manage_organization'] },
